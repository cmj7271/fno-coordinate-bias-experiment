...
function evaluate_dataset(
    ...
    @info "relative_l2_count=$(length(rel_l2_values)), mean=$relative_l2_mean, std=$relative_l2_std"
    ...
    #
    # Only meaningful for translation-relative / periodic problems.
    # For FNO + coordinate, Metrics.shift_equivariance_error should shift only physical channels
    # and keep the coordinate channel fixed.
    ...
    # 8. Boundary error
    #
    # Only meaningful for Dirichlet-type problems.
